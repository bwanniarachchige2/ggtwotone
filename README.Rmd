...
[![Codecov test coverage](https://codecov.io/gh/bwanniarachchige2/ggtwotone/graph/badge.svg)](https://app.codecov.io/gh/bwanniarachchige2/ggtwotone)
...
-   geom_dual_function(): Plot mathematical or statistical
    functions as smooth dual-stroke curves
    
-   geom_path_dual(): Dual-stroke paths for connected lines across multiple points
...
-   highlight_colors(): Generate high-contrast highlight palettes that remain distinct from the background and base color
...
```{r example7, fig.width = 9, fig.height=3}
