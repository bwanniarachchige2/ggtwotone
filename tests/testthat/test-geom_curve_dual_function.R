test_that("geom_function_dual works with basic function", {
  p <- ggplot2::ggplot() +
    geom_function_dual(
      fun = dnorm,
      xlim = c(-2, 2),
...
test_that("geom_function_dual computes fallback contrast color", {
  p <- ggplot2::ggplot() +
    geom_function_dual(
      fun = dnorm,
      xlim = c(-2, 2),
...
test_that("geom_function_dual works with smooth = TRUE", {
  p <- ggplot2::ggplot() +
    geom_function_dual(
      fun = dnorm,
      xlim = c(-3, 3),
...
test_that("geom_function_dual handles invalid function args", {
  warnings <- character()
...
test_that("geom_function_dual works with base_color branch", {
  p <- ggplot2::ggplot() +
    geom_function_dual(
      fun = dnorm,
      xlim = c(-2, 2),
...
test_that("geom_function_dual accepts color1 and color2 aliases", {
  p <- ggplot2::ggplot() +
    geom_function_dual(
      fun = dnorm,
      xlim = c(-2, 2),
...
test_that("geom_function_dual uses default colors when none supplied", {
  p <- ggplot2::ggplot() +
    geom_function_dual(
      fun = dnorm,
      xlim = c(-2, 2),
...
test_that("geom_function_dual works with smooth = FALSE", {
  p <- ggplot2::ggplot() +
    geom_function_dual(
      fun = dnorm,
      xlim = c(-2, 2),
...
test_that("geom_function_dual enforces ncp minimum in non-smooth mode", {
  p <- ggplot2::ggplot() +
    geom_function_dual(
      fun = dnorm,
      xlim = c(-2, 2),
