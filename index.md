...
[`geom_text_contrast()`](reference/geom_text_contrast.md) on a confusion
...
[`geom_text_contrast()`](reference/geom_text_contrast.md) automatically
selects a readable foreground color for each label based on the tile
background, improving readability while preserving the underlying color
scale.
